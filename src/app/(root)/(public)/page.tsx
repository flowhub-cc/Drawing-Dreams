        ...
        <div className='flex flex-col md:flex-row items-center justify-between gap-4'>
            ...
            <div className='flex items-center gap-3'>
              <div className='flex gap-2'>
                {["days", "hours", "minutes", "seconds"].map((unit, index) => (
                  <div key={unit} className='text-center'>
                    <div className='px-3 py-2 min-w-13 bg-white/20 backdrop-blur-sm rounded-xl border border-white/30'>
          ...
          <div className='flex items-center gap-6'>
            <div className='text-center'>
              ...
              <div className='text-xl font-bold bg-linear-to-r from-amber-200 to-yellow-200 bg-clip-text text-transparent'>
        ...
        <div className='container mx-auto max-w-6xl'>
          <div className='text-center mb-12 md:mb-16'>
            <button
              ...
              className='inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-orange-400 to-amber-400 text-white rounded-full mb-4 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group'
            >
          ...
          <div className='flex flex-col lg:flex-row items-center gap-12 lg:gap-16'>
            ...
            <div className='lg:w-3/5'>
              ...
              <p className='text-xl text-orange-600 font-semibold mb-8 bg-linear-to-r from-orange-100 to-amber-100 p-4 rounded-xl border border-amber-200'>
                7+ Years Experience • 1500+ Students
              </p>
          ...
          <div className='relative overflow-hidden rounded-3xl shadow-2xl p-8 md:p-12 border-2 border-amber-400/50'>
            ...
            <div className='relative z-10 text-center text-white'>
              ...
              <div className='flex justify-center text-white gap-5'>
                <h2 className='text-3xl md:text-4xl lg:text-5xl font-bold mb-6'>
                  Ready to Transform
                  <span className='block bg-linear-to-r from-amber-200 to-yellow-200 bg-clip-text text-transparent mt-2'>
                ...
                <div className='inline-flex flex-col sm:flex-row items-center gap-6 bg-white/20 backdrop-blur-sm rounded-2xl p-8 border border-white/30'>
                  <div className='text-center'>
                    <div className='text-3xl md:text-6xl font-bold mb-3'>
                      <span className='bg-linear-to-r from-amber-200 to-yellow-200 bg-clip-text text-transparent whitespace-nowrap'>
                        Rs.30/- ONLY
                      </span>
                    </div>
                  </div>
                  ...
                  <div className='text-left mt-2 sm:mt-0'>
                    <div className='text-amber-50 px-4 py-1.5 bg-linear-to-r from-orange-600 to-amber-600 rounded-full text-sm whitespace-nowrap'>
                      Limited Spots Left
                    </div>
                  </div>
                </div>
