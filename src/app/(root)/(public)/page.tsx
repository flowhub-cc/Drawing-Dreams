...
const WEBINAR_CONFIG = {
  DATE_TIME: "2026-01-25 19:00:00",
  TIMEZONE: "Asia/Kolkata",
  RAZORPAY_LINK: "https://pages.razorpay.com/pl_S1rM8ZrphWo5il/view",
  PRICE: {
    original: "₹999",
...
// Enhanced Orange Gradient Palette
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="hidden md:flex items-center gap-2 px-3 py-1.5 bg-white/20 backdrop-blur-sm rounded-full border border-white/30">
              ...
              <span className="text-amber-0 text-sm font-medium">
                Limited Time Offer
              </span>
            </div>
          ...
          <div className="flex items-center gap-6">
            <div className="text-center">
              <div className="text-bold text-sm text-amber-50 line-through opacity-75">
                Rs. 999
              </div>
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      quote:
        "I was overwhelmed by where to start. This workshop gave me the clarity and roadmap I needed. Now I create art daily with confidence!",
      duration: "",
    ...
    },
    {
      ...
      role: "Hobby Artist",
      quote:
        "Meenakshi ma'am breaks down complex concepts so simply. I went from confused about mediums to confidently exploring watercolors!",
      duration: "",
    ...
    },
    {
      ...
      role: "Student",
      quote:
        "The mindset shift was everything. Worth every penny! I've already recommended it to three friends who were also stuck.",
      duration: "",
    ...
    },
    {
      ...
      role: "Art Student",
      quote:
        "Best investment in my art journey. Learned more in 90 minutes than in months of trying to figure it out on my own!",
      duration: "",
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-xl text-orange-700 mb-10 leading-relaxed bg-gradient-to-r from-orange-100/50 to-amber-100/50 p-6 rounded-2xl border border-amber-200">
              Join this live webinar to transform confusion into confidence, and
              get the{" "}
              <span className="font-semibold text-orange-600">
                clarity, roadmap, and mindset
              </span>{" "}
              you need to start creating art you're proud of.
            </p>
          </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: Shield,
                title: "Eliminate Fear & Self-Doubt",
                description:
                  "Break through mental barriers that keep you from picking up that first brush or pencil.",
              },
              {
                icon: Map,
                title: "Clear Progression Roadmap",
                description:
                  "Get step-by-step guidance on what to learn, in what order, and how to measure progress.",
              },
              {
                icon: Palette,
                title: "Medium Mastery Blueprint",
                description:
                  "Understand different art supplies and confidently choose what's right for your journey.",
              },
              {
                icon: Brain,
                title: "Growth Mindset Foundation",
                description:
                  "Build the unshakable belief that artistic skill is developed, not inherited.",
              },
              {
                icon: Heart,
                title: "Beginner-First Philosophy",
                description:
                  "Learn through methods designed specifically for those starting from zero.",
              },
              {
                icon: TrendingUp,
                title: "Confidence Acceleration",
                description:
                  "Transform from feeling intimidated to feeling excited about your creative potential.",
              },
            ].map((item, index) => (
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="lg:w-3/5">
              ...
              <p className="text-xl text-orange-600 font-semibold mb-8 bg-gradient-to-r from-orange-100 to-amber-100 p-4 rounded-xl border border-amber-200">
                Founder, Drawing Dreams Art Institute • 7+ Years Empowering
                Beginners
              </p>
              ...
              <div className="mb-10">
                <div className="inline-flex flex-col sm:flex-row items-center gap-6 bg-white/20 backdrop-blur-sm rounded-2xl p-8 border border-white/30">
                  <div className="text-center">
                    ...
                    <div className="text-amber-50 text-sm opacity-80">
                      One-Time Investment
                    </div>
                  </div>
